                ...
                <div class="menu-container">
                    <ul class="menu-nav-tabs">
                        <li class="menu-nav-item">
                            <a class="menu-nav-font" href="menu.aspx">精選組合</a>
                        </li>
                        <li class="menu-nav-item">
                            <a class="menu-nav-font" href="menu.aspx">披薩口味</a>
                        </li>
                        <li class="menu-nav-item">
                            <a class="menu-nav-font" href="menu.aspx">披薩餅皮</a>
                        </li>
                        <li class="menu-nav-item">
                            <a class="menu-nav-font" href="menu.aspx">副食介紹</a>
                        </li>
                    </ul>
                </div>
            </div>
