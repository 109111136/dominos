<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="delivery.aspx.cs" Inherits="dominos.half_price" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <main class="main">
            <div style="text-align:center;"><h2>輸入外送地址 </h2></div>
            <asp:Panel ID="Panel1" runat="server" Height="200px" Width="40%" CssClass="delivery" HorizontalAlign="Left">
